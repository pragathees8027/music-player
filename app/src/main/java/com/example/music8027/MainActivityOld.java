...
public class MainActivityOld extends AppCompatActivity {
    ...
    public void requestPermission() {
        ...
        for (String s : permission) {
            if (ActivityCompat.checkSelfPermission(MainActivityOld.this, s)
                    != PackageManager.PERMISSION_GRANTED && ActivityCompat.
                    checkSelfPermission(MainActivityOld.this, s)
                    != PackageManager.PERMISSION_GRANTED) {
                req = true;
            }
        }
        if (req){
            ActivityCompat.requestPermissions(MainActivityOld.this, new String[] {permission[0],permission[1],permission[2],permission[3],permission[4],permission[5],permission[6]}, 1);
        }
    }
